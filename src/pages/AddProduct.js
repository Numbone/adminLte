                ...
                <form ref={form} onSubmit={postProductCreate}>
                  <div className="card-body">
                    <div className="form-group">
                      <label htmlFor="abbr">Аббревиатура</label>
                      <input
                        type="text"
                        className="form-control"
                        placeholder="Введите уникальный aббревиатура товара"
                        name="abbr"
                      />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <Form.Select className="form-control" name="categoryEn">
                        {categoryMassive?.map((item, index) => (
                          <option
                            style={
                              category === item?.name_ru
                                ? { display: "block" }
                                : { display: "none" }
                            }
                            value={
