...
const ChangeProduct = () => {
  ...
  const getCategory = async () => {
    ...
    setCategoryMassive([
      { id: 0, name_ru: "Выберите категорию " },
      ...data?.all_category,
    ]);
  };
  ...
  const setImageEn = async (id) => {
    for (let r = 0; r < fileEn.length; r++) {
      const element = fileEn[r];
      let car = new FormData();
      car.append("id", String(id));
      car.append("file", element);
  ...
  const setImageRu = async (id) => {
    for (let i = 0; i < fileRu.length; i++) {
      let formData = new FormData();
      formData.append("id", String(id));
      const element = fileRu[i];
                ...
                <div className="card-body">
                  ...
                  {changeRus ? (
                    <>
                      ...
                      <div className="form-group">
                        <label htmlFor="contraindicationsRu">
                          Противопоказание
                        </label>
                        <textarea
                          onChange={(e) =>
                            setContraindicationsRu(e.target.value)
                          }
                          type="text"
                          className="form-control"
                      ...
                      <div className="form-group">
                        <div class="mb-3 input-group">
                          ...
                          <input
                            ...
                            class="form-control"
                            multiple
                            onChange={(e) => setFileRu(e.target.files)}
                          />
                        </div>
                      </div>
                  ...
                  {changeEn ? (
                    <>
                      ...
                      <div className="form-group">
                        <label htmlFor="contraindicationsEn">
                          Противопоказание
                        </label>
                        <textarea
                          onChange={(e) =>
                            setContraindicationsEn(e.target.value)
                          }
                          type="text"
                          className="form-control"
                      ...
                      <div className="form-group">
                        <div class="mb-3 input-group">
                          ...
                          <input
                            ...
                            class="form-control"
                            multiple
                            onChange={(e) => setFileEn(e.target.files)}
                          />
                        </div>
                      </div>
                      <div className="form-group" style={{ display: "flex" }}>
