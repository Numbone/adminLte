...
export const productUpdate=async(action,category,compound,contraindications,count,description,id,lang,modeOfApp,name,price,weight)=>{
    const data = await instance.patch("/product/update",{action,category,compound,contraindications,count,description,id,lang,modeOfApp,name,price,weight})
    return data
}
