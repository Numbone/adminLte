...
import PromocodeChange from "./pages/PromocodeChange";
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/promocodechange" element={<PromocodeChange />}></Route>

        <Route path="/pdf" element={<Pdf />}></Route>
        <Route
          path="/changetransaction"
          element={<ChangeTransaction />}
        ></Route>
